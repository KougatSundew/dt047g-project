...
QT_MOC_LITERAL(1, 15, 18), // "loginButtonPressed"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 8), // "username"
QT_MOC_LITERAL(4, 44, 8), // "password"
QT_MOC_LITERAL(5, 53, 17), // "attemptConnection"
QT_MOC_LITERAL(6, 71, 17), // "connectedToServer"
QT_MOC_LITERAL(7, 89, 22), // "disconnectedFromServer"
QT_MOC_LITERAL(8, 112, 15) // "onLoginBtnPress"

    },
    "StartingWindow\0loginButtonPressed\0\0"
    "username\0password\0attemptConnection\0"
...
void StartingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginButtonPressed((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->attemptConnection(); break;
        case 2: _t->connectedToServer(); break;
        case 3: _t->disconnectedFromServer(); break;
        case 4: _t->onLoginBtnPress(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StartingWindow::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartingWindow::loginButtonPressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartingWindow::loginButtonPressed(QString _t1, QString _t2)
{
